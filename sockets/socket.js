    ...
    socket.on("mensaje", async (mensaje) => {
      ...
      switch (mensajeConvertido) {
        ...
        case "viernes":
          if (!nombreUsuario) {
            respuesta =
              " <span style='color: white;'>Por favor, primero dime tu nombre.</span>";
          } else {
            diaCita = mensaje;
        ...
        case "12":
          if (!diaCita) {
            respuesta =
              " <span style='color: white;'>Por favor, primero dime el día en que te gustaría agendar la cita.</span>";
          } else {
        ...
        case "aceptar":
          if (!nombreUsuario || !diaCita) {
            respuesta =
              "<span style='color: white;'>Lo siento, parece que hay un problema. ¿Puedes repetirlo?</span>";
          } else {
        ...
        case "negar":
          respuesta =
            "<span style='color: white;'>Entendido, la cita no ha sido agendada. ¿Hay algo más en lo que pueda ayudarte?</span>";
        ...
        case "informacion":
          respuesta =
            "<span style='color: white;'>Nuestra empresa es una empresa de ejemplo que brinda servicios de ejemplo. ¿En qué más puedo ayudarte?</span>";
          break;
        case "ip":
          console.log("Información del handshake:", socket.handshake);
          respuesta =
            "<span style='color: white;'>La dirección IP del cliente es:";
          "</span>";
          break;
        case "salir":
          respuesta =
            "<span style='color: white;'>¡Hasta luego! Si necesitas algo más, estaré aquí. 😊 Adios</span>";
          nombreUsuario = ""; // Limpiar el nombre de usuario al finalizar la conversación
          diaCita = ""; // Limpiar el día de la cita al finalizar la conversación
          break; // Agregar este break para salir del bloque switch
        case "temp": // tempeture usando una api de mexico
          const temp = await fetch(
            "https://api.openweathermap.org/data/2.5/weather?q=Mexico&appid=a586e35a1621378bd6b409b8f1e3093d"
          );
